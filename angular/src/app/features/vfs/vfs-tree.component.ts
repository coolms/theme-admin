...
@Component({
    ...
    styles: [`
        ...
        /* VFS live updates -- 2s fade flash on a row whose node
...
export class VfsTreeComponent implements OnInit {
    ...
    /**
     * VFS live updates -- root node UUID, resolved once on mount
    ...
    /**
     * VFS live updates -- ids of currently flashing nodes. Each
    ...
    constructor() {
        ...
        // VFS live updates -- reconcile the live-subscription set
    ...
    ngOnInit(): void {
        ...
        this.fetchPath(this.rootPath);
        // VFS live updates -- one-shot root stat to discover the
