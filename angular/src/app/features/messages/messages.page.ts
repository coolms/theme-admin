...
@Component({
    ...
    styles: [`
        ...
        .msg__browse--on { background: var(--cms-accent-light); color: var(--cms-accent-text); border-color: var(--cms-selected); }
        ...
        .msg__newmode-btn--on { background: var(--cms-accent-light); color: var(--cms-accent-text); border-color: var(--cms-selected); font-weight: 500; }
        ...
        .msg__members-btn--on { background: var(--cms-accent-light); color: var(--cms-accent-text); border-color: var(--cms-selected); }
        ...
        .msg__composer-grip:hover::before, .msg__composer-grip--active::before { opacity: 1; background: var(--cms-accent); }
        ...
        .msg__tool--on { background: var(--cms-accent-light, #FEF7E6); color: var(--cms-accent-text); }
